                                            ...
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                        ...
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                <td width="100%" align="center">
                                                                    ...
                                                                    <div style="display:block; font-size:0pt; line-height:0pt; height:25px;"></div>

                                                                    <div class="primary-color" style="font-family: Arial, Helvetica, sans-serif; font-size: 18px; color: #57697e; font-weight: 600;">
                                                                        {{$eventTransaction->event->title}}
                                                                    </div>
                                                                    ...
                                                                    <div class="secondary-color" style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; color: #FBB819; font-weight: 600;">
                                                                        {{ Carbon\Carbon::parse($eventTransaction->event->date_time)->format('l dS F Y') }}

                                                                    </div>

                                                                    <div style="display:block; font-size:0pt; line-height:0pt; height:10px;"></div>

                                                                    <div class="primary-color"class="primary-color" style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; color: #57697e; font-weight: 600;">
                                                                        {{$eventTransaction->event->location}}, {{ Carbon\Carbon::parse($eventTransaction->event->date_time)->format('h:i:s a')}}
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    ...
                                                    <td width="30" class="column" align="right" valign="bottom">
                                                        <div style="display:block; font-size:0pt; line-height:0pt; height:15px;"></div>
                                                        <div class="text-center">
                                                            <img src="{{$eventTransaction->event->image}}" border="0" alt="Event" width="100%" style="width:100%; max-width: 30px;">
                                                        </div>
                                                    </td>
                                                </tr>
                                            </table>
                                ...
                                {{-- <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-top: 1px solid #F1F1F1;">
                                    <tr>
                                        ...
                                        <td width="620" align="center">
                                            ...
                                            <div class="primary-color" style="font-family: Arial, Helvetica, sans-serif; font-size: 18px; color: #57697e; font-weight: 600;">
                                                Please present this code when attending
                                            </div>

                                            <div style="display:block; font-size:0pt; line-height:0pt; height:20px;"></div>

                                            <div style="font-size:0pt; line-height:0pt;">
                                                <img src="{{ \Storage::disk('s3')->url('')}}{{config('fanslive.IMAGEPATH.booked_event_qrcode').$eventTransaction->id}}.png" border="0" alt="qrCode" width="100%" style="width:100%; max-width: 220px;">
                                            </div>
                                        ...
                                        <td width="620" align="center">
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td width="430">
                                                        <div class="primary-color" style="font-family: Arial, Helvetica, sans-serif; font-size: 18px; color: #57697e;font-weight: 600;">
                                                            Receipt {{$eventTransaction->receipt_number}}
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="430">
                                                        <div class="primary-color" style="font-family: Arial, Helvetica, sans-serif; font-size: 18px; color: #57697e;">
                                                            {{--  @foreach($eventTransaction->bookedEvents as $key=>$val)
                                                                    {{ $loop->first ? '' : ', ' }}
                                                                    {{ $val->seat }}
                                                           @endforeach --}}{{$eventTransaction->event->title}}
                                                        </div>
                                                    </td>

                                                    <td width="150" align="right" valign="top">
                                                        <div class="primary-color" style="font-family: Arial, Helvetica, sans-serif; font-size: 18px; color: #57697e;">
                                                             @if($eventTransaction->currency === 'GBP')   &#163; @else € @endif{{ $eventTransaction->price}}
                                                        </div>
                                                    </td> 
                                                </tr>
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td width="100%" align="right">
                                                        @if($eventTransaction->card_details)
                                                        <div class="primary-color" style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; color: #57697e;">
                                                            Paid with <span style="display: inline-block; vertical-align: middle;"></span> <span>{{json_decode($eventTransaction->card_details)->maskedAccount}}</span>
                                                        </div>
                                                        @endif
                                                    </td>
                                                </tr>
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td width="620" align="center">
                                            ...
                                            <div class="primary-color" style="font-family: Arial, Helvetica, sans-serif; font-size: 18px; color: #57697e; font-weight: 600;">
                                                You earned @if(isset($eventTransaction->loyaltyRewardPoints)) {{$eventTransaction->loyaltyRewardPoints->points}} @else 0 @endif loyalty points
                                            </div>
