                                                ...
                                                <tr>
                                                    <td width="100%" align="center">
                                                        ...
                                                        <div class="primary-color" style="font-family: Arial, Helvetica, sans-serif; font-size: 24px; color: #57697e; font-weight: 600; letter-spacing: 2px;">
                                                            {{$productTransaction->productTransactionCollection->id}}
                                                        </div>
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td width="300" align="center" class="column">
                                                        <div class="primary-color" style="font-family: Arial, Helvetica, sans-serif; font-size: 18px; color: #57697e;">
                                                            Collection point: 
                                                            <span class="primary-color" style="font-size: 20px; color: #57697e; font-weight: 600;">{{$productTransaction->collectionPoint->title}}</span>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </table> 
                                                    ...
                                                    <td width="300" align="center" class="column">
                                                        <div class="primary-color" style="font-family: Arial, Helvetica, sans-serif; font-size: 18px; color: #57697e;">
                                                            ...
                                                            <span class="primary-color" style="font-size: 20px; color: #57697e; font-weight: 600;">
                                                                {{ Carbon\Carbon::parse($productTransaction->collection_time)->format('g:i a') }}
                                                            </span>
                                                        </div>
                                                    </td>
                                                </tr>
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-top: 1px solid #F1F1F1;">
                                    <tr>
                                        ...
                                        <td width="620" align="center">
                                            ...
                                            <div style="font-size:0pt; line-height:0pt;">
                                                <img src="{{ \Storage::disk('s3')->url('')}}{{config('fanslive.IMAGEPATH.product_transaction_qrcode').$productTransaction->id}}.png" border="0" alt="qrCode" width="100%" style="width:100%; max-width: 220px;">
                                            </div>
                                        ...
                                        <td width="620" align="center">
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td width="430">
                                                        <div class="primary-color" style="font-family: Arial, Helvetica, sans-serif; font-size: 18px; color: #57697e;font-weight: 600;">
                                                            Receipt {{$productTransaction->receipt_number}}
                                                        </div>
                                                    </td>
                                                ...
                                                @foreach($productTransaction->purchasedProducts as $key=>$val)
                                                    <tr>
                                                        ...
                                                        <td width="150" align="right" valign="top">
                                                            <div class="primary-color" style="font-family: Arial, Helvetica, sans-serif; font-size: 18px; color: #57697e;">
                                                                @if($productTransaction->currency === 'GBP')   &#163; @else € @endif {{$val->total_price}}
                                                            </div>
                                                        </td> 
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="150" align="right">
                                                            <div class="primary-color" style="font-family: Arial, Helvetica, sans-serif; font-size: 18px; color: #57697e; font-weight: 600;">
                                                                @if($productTransaction->currency === 'GBP')   &#163; @else € @endif {{$productTransaction->price}}
                                                            </div>
                                                        </td> 
                                                    </tr> 
                                                    @endif
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td width="100%" align="right">
                                                        @if($productTransaction->card_details)
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td width="620" align="center">
                                            ...
                                            <div class="primary-color" style="font-family: Arial, Helvetica, sans-serif; font-size: 18px; color: #57697e; font-weight: 600;">
                                                You earned @if(isset($productTransaction->loyaltyRewardPoints)) {{$productTransaction->loyaltyRewardPoints->points}} @else 0 @endif loyalty points
                                            </div>
