...
var CompetitionEdit = function() {

    var initFormValidations = function () {
        var competitionForm = $('.edit-competition-form');
...
function initializeClubs() {
    vueCompetitionClubs = new Vue({
        ...
        data: {
            allClubs: Site.clubs,
            selectedClub: '',
            competitionClubs: Site.competitionClubs,
        },
        created: function() {
        },
        computed: {
...
function readLogoURL(input) {
    if (input.files && input.files[0]) {
        ...
        reader.onload = function(e) {
            ...
            $('#logo_preview_container').html('<div class="logo_preview_container ml-3"><img class="" src="' + e.target.result + '" /></div>');
        }
