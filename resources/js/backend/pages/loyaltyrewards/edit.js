var LoyaltyRewardsEdit = function() {

    var initFormValidations = function () {
        var userForm = $('.edit-loyaltyreward-form');
        ...
        if (jQuery('#js-ckeditor:not(.js-ckeditor-enabled)').length) {
            CKEDITOR.replace('js-ckeditor').on( 'change', function(e) {
                ...
                if(editorcontent.length > 0) {
                    ...
                    $(".js-loyaltyrewards-update").trigger("click");
                }
            });
