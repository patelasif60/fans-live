var MembershipPackageCreate = function () {

	var initFormValidations = function () {
		var MembershipPackageForm = $('.create-membership-package-form');
		...
		$('.create-membership-package-form').data('validator').settings.ignore = ".note-editor *";
	};
