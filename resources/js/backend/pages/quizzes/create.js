...
var questionInformationPageContent = [];
...
function addEndOfQuizResponse(addEndOfQuizId) {
	// var addEndOfQuizQuizResponse = '<div class="block block-bordered block-default block-rounded js-quiz-response-main-div"> <div class="block-header block-header-default"> <div></div><div class="block-options"><button type="button" class="btn-block-option js-add-response-delete text-danger" title="" data-original-title="Delete"><i class="fal fa-trash"></i></button></div></div><div class="block-content"> <div class="row"> <div class="col-xl-8"><div class="form-group"><label for="end_of_quiz_quiz_text" class="required">Text:</label><input type="text" class="form-control end-of-quiz-quiz-text" id="end_of_quiz_quiz_text' + addEndOfQuizId + '" name="end_of_quiz_quiz_text[' + addEndOfQuizId + ']" value=""></div></div><div class="col-xl-4"><div class="form-group"><label for="end_of_quiz_points_thershold" class="required">Points thershold:</label><input type="number" class="form-control end-of-quiz-points-thershold" id="end_of_quiz_points_thershold' + addEndOfQuizId + '" name="end_of_quiz_points_thershold[' + addEndOfQuizId + ']"></input></div></div></div></div></div>';
...
// Validation for end of quiz text
