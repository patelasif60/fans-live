var ProductCreate = function () {
	...
	var initFormValidations = function () {
		var productForm = $('.create-product-form');
		...
		$('.create-product-form').data('validator').settings.ignore = ".note-editor *";
	};
...
function addCustomOption(addCustomOptionId) {
	...
	$('#add_custom_option').append('<div class="col-xl-12 add-home-team" id=' + addCustomOptionId + '>' + addCustomOptionHtml + '</div>');
