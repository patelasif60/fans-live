...
class CreateHospitalitySuiteTransactionsTable extends Migration
{
	/**
	 * Run the migrations.
	 *
	...
	public function up()
	{
		Schema::create('hospitality_suite_transactions', function (Blueprint $table) {
			$table->increments('id');
	...
	{
		Schema::dropIfExists('hospitality_suite_transactions');
	}
}
